...
import com.kengz.sevenminworkoutapp.databinding.ActivityExerciseBinding
import com.kengz.sevenminworkoutapp.databinding.DialogCustomBackConfirmationBinding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setupRestView() {
        ...
        try {
            val soundURI =
                Uri.parse("android.resource://com.kengz.sevenminworkoutapp/" + R.raw.press_start)
    ...
    private fun setupExerciseView() {
        ...
        val exerciseName = exerciseList!![currentExercisePosition].name
